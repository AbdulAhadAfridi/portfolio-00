...
const SERVICES = [
  {
    ...
    description: "Fully tailored websites built from scratch to match your brand, vision, and business needs with pixel-perfect execution.",
    color: "#00e5ff",
  },
  {
    icon: Smartphone,
    title: "Responsive Web Design",
    description: "Beautiful, mobile-first designs that look and perform flawlessly on every device — phones, tablets, and desktops.",
    color: "#a855f7",
  },
  {
    icon: Code2,
    title: "Frontend Development (React / Next.js)",
    description: "Fast, interactive, and SEO-optimized front-end applications built with React.js and Next.js for a premium user experience.",
    color: "#22c55e",
  },
  {
    icon: Server,
    title: "Python Backend Development",
    description: "Robust, scalable server-side solutions using Python, FastAPI, and Django for data processing and API development.",
    color: "#f59e0b",
  },
  {
    icon: Bot,
    title: "AI Chatbot Integration",
    description: "Intelligent chatbot systems powered by AI to automate customer support, lead generation, and user engagement.",
    color: "#ec4899",
  },
  {
    icon: Rocket,
    title: "Landing Pages for Startups",
    description: "High-converting landing pages designed for startups — fast loading, visually stunning, and optimized for conversions.",
    color: "#06b6d4",
  },
  {
    icon: Wrench,
    title: "Website Optimization & Maintenance",
    description: "Speed optimization, bug fixes, security updates, and ongoing maintenance to keep your website running at peak performance.",
    color: "#8b5cf6",
  },
  {
    icon: Layout,
    title: "CMS Development",
    description: "Custom content management systems and admin dashboards so you can manage your website content independently.",
    color: "#14b8a6",
  },
  {
    icon: Database,
    title: "Database & API Design",
    description: "Efficient database architecture and RESTful/GraphQL APIs designed for scalability and optimal performance.",
    color: "#f97316",
  },
  {
    icon: Shield,
    title: "E-Commerce Solutions",
    description: "Full e-commerce platforms with payment integration, inventory management, and seamless checkout experiences.",
    color: "#ef4444",
  },
];
